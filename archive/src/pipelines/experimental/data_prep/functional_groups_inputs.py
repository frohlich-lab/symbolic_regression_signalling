...
* ``functional_groups_time_series.csv``
* ``functional_groups_feature_matrix.csv``
* ``functional_groups_fit_snapshot.csv``
* ``functional_groups_per_minute_fit.csv``
...
LOGGER = logging.getLogger("data_prep.functional_groups_inputs")
...
def run_processing(args: argparse.Namespace) -> None:
    ...
    output_payload = {
        "functional_groups_time_series.csv": time_df,
        "functional_groups_feature_matrix.csv": filtered_df,
        "functional_groups_fit_snapshot.csv": extra_df,
        "functional_groups_per_minute_fit.csv": dense_df,
    }
